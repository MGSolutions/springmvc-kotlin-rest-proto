...
public class ClientGZipContentCompression {
    ...
    public final static void mainX(String[] args) throws Exception {
        ...
        try {
            ...
            httpclient.addResponseInterceptor(new HttpResponseInterceptor() {
                ...
                public void process(
                    ...
                    // mgrigorov: Since there is no "Content-Encoding: gzip" in the response headers we do it without the checks below
                    // mgrigorov: Uncomment the following line to see the error when trying to decompress
//                    response.setEntity(new GzipDecompressingEntity(response.getEntity()));
                }

            });

            HttpGet httpget = new HttpGet("http://10.6.238.176:9401/bmgsongsrestapi/bmgsongs/data/song?page=1&per_page=50");
